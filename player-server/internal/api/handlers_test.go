...
func TestServer_StaticPages(t *testing.T) {
	...
	t.Run("css public", func(t *testing.T) {
		...
		srv := newTestServer(t, store, nil, nil, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, fs)
...
func TestServer_Bootstrap(t *testing.T) {
	...
	t.Run("wrong method", func(t *testing.T) {
		srv := newTestServer(t, nil, hasher, nil, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestServer_SessionCookieSecure(t *testing.T) {
	...
	t.Run("clear cookie respects Secure config", func(t *testing.T) {
		...
		cfg := &internal.Config{SessionTimeoutHours: 24, SecureCookies: false}
		srv := newTestServer(t, sessStore, nil, logoutSM, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestServer_Readyz(t *testing.T) {
	t.Run("ping ok", func(t *testing.T) {
		...
		srv := newTestServer(t, store2, nil, nil, &internal.Config{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestServer_MediaList(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			srv := newTestServer(t, buildCountStore(1), hasher, sm, cfg, ms, ms, ms, ms, ms, ms, nil, nil, nil, nil)
